...
/* 
Possible bugs are:
- In the mint there is no onlyOwner()
- burn should not be onlyOwner
- Nor in the approve
- In the transfer and transferFrom is not validated overflow
- In the burn and in the mint it is not validated under and over flow
- tx.origin 
*/
