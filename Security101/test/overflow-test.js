...
describe("SimpleToken", function () {
    ...
    it.skip("Should revert if the user tries to transfer an amount greater than its balance", async function () {
    ...
    it("Should overflow if an attacker transfer an amount greater than its balance", async function () {
        await this.simpleToken.transfer(attacker.address, 10);
