...
describe("Access Control", () => {
    ...
    describe("AgreedPrice", () => {
        ...
        it("Should NOT be possible for other than the owner to change price", async function () {
            //await outside of the expect function because we want to check if the message is thrown to see if it passes.
        ...
        it("Should be possible for the new owner to call updatePrice", async function () {
            await this.agreedPrice.transferOwnership(user.address);
